...
class ProductManagerTest {
    ...
    void testGetProductsByPriceRange() {
        ProductManager manager = new ProductManager();
        manager.addProduct(new Product("1", "Portatil", "PC", 1200.0));
        manager.addProduct(new Product("2", "Teclado", "periferico", 40.0));

        List<Product> result = manager.getProductsByPriceRange(30.0, 600.0);
